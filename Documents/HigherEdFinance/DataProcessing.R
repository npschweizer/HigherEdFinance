dfPublic = data.frame(read.csv("Data.csv", header = TRUE),
...
dfPrivate$Institution<- as.character(dfPrivate$Insitution)
...
df_tot$SpendtoRevenueRatio = df_tot$Spending.on.instruction/df_tot$Revenue.from.tuition.and.fees